    ...
    <div class="kt-portlet kt-portlet--mobile">
      ...
      <div class="kt-portlet__body">
        ...
        <form id="submit_form" method="get" action="<?= base_url('lap_honor_dokter') ?>">
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-7">
              <select name="model" class="form-control input" id="model" data-id="model" onChange="changeModel()">
                <option selected value="">Silahkan Pilih</option>
                <option value="2" <?php if ($this->input->get('model') == 2) {
                                    echo 'selected';
                                  } ?>>Per Tahun</option>
                <option value="1" <?php if ($this->input->get('model') == 1) {
                                    echo 'selected';
                                  } ?>>Per Bulan</option>
                <option value="3" <?php if ($this->input->get('model') == 3) {
                                    echo 'selected';
                                  } ?>>Per Hari</option>
              </select>
            </div>
          ...
          <div class="form-group row div_tanggal_akhir" style="display:none;" autocomplete="off">
          ...
          <div class="form-group row div_bulan" style="display:none;">
            ...
            <div class="col-lg-7">
              <select name="bulan" class="form-control input" id="bulan" data-id="bulan">
                <option selected value="">Silahkan Pilih</option>
                <option value="1" <?php if ($this->input->get('bulan') == 1) {
                                    echo 'selected';
                                  } ?>>Januari</option>
                <option value="2" <?php if ($this->input->get('bulan') == 2) {
                                    echo 'selected';
                                  } ?>>Februari</option>
                <option value="3" <?php if ($this->input->get('bulan') == 3) {
                                    echo 'selected';
                                  } ?>>Maret</option>
                <option value="4" <?php if ($this->input->get('bulan') == 4) {
                                    echo 'selected';
                                  } ?>>April</option>
                <option value="5" <?php if ($this->input->get('bulan') == 5) {
                                    echo 'selected';
                                  } ?>>Mei</option>
                <option value="6" <?php if ($this->input->get('bulan') == 6) {
                                    echo 'selected';
                                  } ?>>Juni</option>
                <option value="7" <?php if ($this->input->get('bulan') == 7) {
                                    echo 'selected';
                                  } ?>>Juli</option>
                <option value="8" <?php if ($this->input->get('bulan') == 8) {
                                    echo 'selected';
                                  } ?>>Agustus</option>
                <option value="9" <?php if ($this->input->get('bulan') == 9) {
                                    echo 'selected';
                                  } ?>>September</option>
                <option value="10" <?php if ($this->input->get('bulan') == 10) {
                                      echo 'selected';
                                    } ?>>Oktober</option>
                <option value="11" <?php if ($this->input->get('bulan') == 11) {
                                      echo 'selected';
                                    } ?>>November</option>
                <option value="12" <?php if ($this->input->get('bulan') == 12) {
                                      echo 'selected';
                                    } ?>>Desember</option>
              </select>
            </div>
          ...
          <div class="form-group row div_dokter" style="display:none;">
            <label class="col-lg-3 col-form-label text-left">Dokter</label>
            <div class="col-lg-7">
              <select name="dokter" class="form-control input" id="dokter" data-id="dokter">
                <option selected value="">Silahkan Pilih</option>
                <?php
                foreach ($data_dokter as $kd => $vd) { ?>
                  <option value="<?= $vd->id ?>" <?php if ($this->input->get('dokter') == $vd->id) {
                                                    echo 'selected';
                                                  } ?>><?= $vd->nama; ?></option>
                <?php } ?>
              </select>
