<html><head>
  ...
  <!-- Main content -->
  <div class="container">     
      <h2 style="text-align: center;"><strong>Laporan Riwayat Pembelian Barang - PT. SPB</strong></h2>
    ...
    <table id="tabelLaporanBeli" class="table table-bordered table-hover" cellspacing="0" width="100%" border="2">
      <thead>
        <tr>
          ...
          <th style="width: 60px; text-align: center;">Tgl PO</th>
          ...
          <th style="width: 60px; text-align: left;">Tgl Masuk</th>
        </tr>
      </thead>
      <tbody>
      <?php $no = 1; ?>
