          ...
          <div class="kt-portlet__body">
            <div class="col-12">
              <div class="alert alert-danger fade show" role="alert">
                ...
                <div class="alert-text">Perhatian !!!. Pasien ini [<?=$datareg->no_reg;?>] telah dipulangkan pada tanggal : <?=tanggal_indo($datareg->tanggal_pulang).' pukul : '.$datareg->jam_pulang;?></div>
