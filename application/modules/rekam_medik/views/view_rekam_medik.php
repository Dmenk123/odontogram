        ...
        <div class="kt-portlet__body">
          ...
          <div class="col-12 table-responsive">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="tabel_pasien">
              ...
              <tbody>
                <tr>
                  <td colspan="8" style="text-align: center;">Data Pasien Tidak Ditemukan</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="kt-portlet__body">
            <div class="col-12">
              <div class="alert alert-danger fade show" role="alert">
                ...
                <div class="alert-text">Pasien [<?= $datareg->no_reg; ?>] telah selesai dilakukan Perekaman Medis : <?= tanggal_indo($datareg->tanggal_pulang) . ' pukul : ' . $datareg->jam_pulang; ?><span style="float: right;cursor:pointer;" onclick="batalkanPulang()"><b><u>Klik disini untuk membatalkan</u></b></span></div>
