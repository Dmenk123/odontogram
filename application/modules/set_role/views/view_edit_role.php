    ...
    <div class="kt-portlet kt-portlet--mobile">
      ...
      <div class="kt-portlet__body">
        ...
        <form class="form-edit-role kt-form" id="form-edit-role" action="<?=base_url()."".$this->uri->segment(1)."/".$this->uri->segment(2);?>_data" method="post">
              ...
              <input type="hidden" value="<?php echo $old_data['id'];?>" name="id_role">
                <div class="form-group">
                  <label class="control-label col-sm-12">Role User :</label>
                  <div class="col-sm-12">
                    <input type="input" class="form-control required" id="nama_role" value="<?php echo $old_data['nama'];?>" name="nama_role">
                  </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <textarea class="form-control" id="keterangan" name="keterangan"><?php echo $old_data['keterangan'];?></textarea>
                  </div>
                </div>
              </div>
              <!-- /.box-header -->
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                  <button type="submit" class="btn btn-primary tombol-simpan"> Ubah Data</button>
