    ...
    <table id="tbl_content" class="table table-bordered table-hover" cellspacing="0" width="100%" border="1">
      <thead>
        <tr>
          ...
          <th style="width: 10%; text-align: center;">Kode ICD</th>
          <th style="width: 30%; text-align: center;">Diagnosa</th>
        </tr>
      </thead>
      <tbody>
        <?php
        foreach ($data as $key => $val) : ?>
          ...
          <tr>
            ...
            <td class="text-center"><?= $val->kode_diagnosa; ?></td>
            <td class="text-center"><?= $val->nama_diagnosa; ?></td>
          </tr>
        <?php endforeach ?>
      </tbody>
    </table>
