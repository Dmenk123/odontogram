...
{
	var $table = 'm_logistik';
	var $column_search = ['kode_logistik','nama_logistik','harga_beli','harga_jual','stok','jenis'];
	...
	var $order = ['m_logistik.nama_logistik' => 'asc']; 
	...
	private function _get_datatables_query($term='')
	{
		...
		$this->db->from('m_logistik');
		$this->db->join('m_jenis_logistik', 'm_jenis_logistik.id_jenis_logistik=m_logistik.id_jenis_logistik');
		$this->db->where('m_logistik.deleted_at is null');
	...
	function get_kode_logistik(){
		$q = $this->db->query("select MAX(RIGHT(kode_logistik,3)) as kode_max from m_logistik");
		$kd = "";
		if($q->num_rows()>0){
